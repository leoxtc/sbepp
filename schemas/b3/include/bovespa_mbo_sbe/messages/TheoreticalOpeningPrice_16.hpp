...
class message_11 : public ::sbepp::detail::message_base<
...
public:
    ...
    static constexpr ::bovespa_mbo_sbe::types::OpenCloseSettlFlag openCloseSettlFlag() noexcept
    {
        return ::bovespa_mbo_sbe::types::OpenCloseSettlFlag{::bovespa_mbo_sbe::detail::types::enum_27::THEORETICAL_PRICE};
    }
    ...
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::QuantityOptional, ::bovespa_mbo_sbe::types::QuantityOptional::value_type, ::sbepp::endian::little>(*this, 28);
    }
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::matchEventIndicator{})
||v.template on_field(this->mDUpdateAction(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDUpdateAction{})
||v.template on_field(this->tradeDate(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::tradeDate{})
||v.template on_field(this->mDEntryPx(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntryPx{})
||v.template on_field(this->mDEntrySize(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntrySize{})
||v.template on_field(this->mDEntryTimestamp(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntryTimestamp{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using TheoreticalOpeningPrice_16 = ::bovespa_mbo_sbe::detail::messages::message_11<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDUpdateAction>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntryType>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::openCloseSettlFlag>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Indicates this is a theoretical opening price";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::tradeDate>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntryPx>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Theoretical Opening Price.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntrySize>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Theoretical Opening Quantity.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::mDEntryTimestamp>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "The theoretical opening price is also sent on this block and is calculated and updated based on the orders presented in the book during every auction including the pre-opening / pre-closing auction.";
    }
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::TheoreticalOpeningPrice_16<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::TheoreticalOpeningPrice_16<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::TheoreticalOpeningPrice_16;
};
