...
class message_22 : public ::sbepp::detail::message_base<
...
public:
    ...
    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::types::QuantityOptional mDEntrySize() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::QuantityOptional, ::bovespa_mbo_sbe::types::QuantityOptional::value_type, ::sbepp::endian::little>(*this, 24);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void mDEntrySize(::bovespa_mbo_sbe::types::QuantityOptional v) const noexcept
    {
    ...
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::RptSeq, ::bovespa_mbo_sbe::types::RptSeq::value_type, ::sbepp::endian::little>(*this, 48);
    }
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::matchEventIndicator{})
||v.template on_field(this->mDEntryType(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntryType{})
||v.template on_field(this->mDEntryPositionNo(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntryPositionNo{})
||v.template on_field(this->mDEntrySize(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntrySize{})
||v.template on_field(this->secondaryOrderID(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::secondaryOrderID{})
||v.template on_field(this->mDEntryTimestamp(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntryTimestamp{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using DeleteOrder_MBO_51 = ::bovespa_mbo_sbe::detail::messages::message_22<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDUpdateAction>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntryType>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntryPositionNo>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntrySize>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Quantity of the deleted order.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::secondaryOrderID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::mDEntryTimestamp>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Disseminates the deletion of a new order.";
    }
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::DeleteOrder_MBO_51<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::DeleteOrder_MBO_51<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::DeleteOrder_MBO_51;
};
