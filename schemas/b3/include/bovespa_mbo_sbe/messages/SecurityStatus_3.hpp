...
class message_5 : public ::sbepp::detail::message_base<
...
public:
    ...
    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::types::SecurityTradingStatus securityTradingStatus() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::SecurityTradingStatus, ::bovespa_mbo_sbe::types::SecurityTradingStatus, ::sbepp::endian::little>(*this, 18);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void securityTradingStatus(::bovespa_mbo_sbe::types::SecurityTradingStatus v) const noexcept
    {
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_compatible_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR auto
        securityTradingStatus(Cursor&& c) const noexcept
        -> ::sbepp::detail::cursor_result_type_t<Cursor, ::bovespa_mbo_sbe::types::SecurityTradingStatus>
    {
        return c.template get_value<::bovespa_mbo_sbe::types::SecurityTradingStatus, ::bovespa_mbo_sbe::types::SecurityTradingStatus, ::sbepp::endian::little>(
            *this, 0, 18);
    }
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_writeable_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR void securityTradingStatus(
        ::bovespa_mbo_sbe::types::SecurityTradingStatus v, Cursor&& c) const noexcept
    {
        return c.template set_value<::sbepp::endian::little>(
            *this, 0, 18, v);
    }
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::matchEventIndicator{})
||v.template on_field(this->tradingSessionID(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::tradingSessionID{})
||v.template on_field(this->securityTradingStatus(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityTradingStatus{})
||v.template on_field(this->securityTradingEvent(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityTradingEvent{})
||v.template on_field(this->tradeDate(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::tradeDate{})
||v.template on_field(this->tradSesOpenTime(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::tradSesOpenTime{})
||v.template on_field(this->transactTime(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::transactTime{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using SecurityStatus_3 = ::bovespa_mbo_sbe::detail::messages::message_5<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::tradingSessionID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityTradingStatus>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Status related to a given instrument.";
    }
    ...
    using value_type_tag = ::bovespa_mbo_sbe::schema::types::SecurityTradingStatus;
};

template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::securityTradingEvent>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Identifies an event related to a Trading. This tag is also used to mark when an instrument state is kept separate from the group phase, or when the instrument state follows the default group phase (stops having a separate, defined state). Always sent when tag 48 is present.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::tradeDate>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::tradSesOpenTime>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Estimated end of the current auction. Only present when SecurityTradingStatus=21 (Pre-open/Reserved).";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::transactTime>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::SecurityStatus_3>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Trading status for instruments";
    }
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::SecurityStatus_3<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::SecurityStatus_3<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::SecurityStatus_3;
};
