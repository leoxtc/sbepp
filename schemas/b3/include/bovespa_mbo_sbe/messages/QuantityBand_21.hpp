...
class message_15 : public ::sbepp::detail::message_base<
...
public:
    ...
    {
        return ::bovespa_mbo_sbe::types::MDEntryType{::bovespa_mbo_sbe::detail::types::enum_31::QUANTITY_BAND};
    }
    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::types::QuantityVolumeOptional avgDailyTradedQty() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::QuantityVolumeOptional, ::bovespa_mbo_sbe::types::QuantityVolumeOptional::value_type, ::sbepp::endian::little>(*this, 20);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void avgDailyTradedQty(::bovespa_mbo_sbe::types::QuantityVolumeOptional v) const noexcept
    {
        ::sbepp::detail::set_value<::sbepp::endian::little>(*this, 20, v.value());
    }
    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::types::QuantityVolumeOptional maxTradeVol() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::QuantityVolumeOptional, ::bovespa_mbo_sbe::types::QuantityVolumeOptional::value_type, ::sbepp::endian::little>(*this, 28);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void maxTradeVol(::bovespa_mbo_sbe::types::QuantityVolumeOptional v) const noexcept
    {
    ...
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::RptSeq, ::bovespa_mbo_sbe::types::RptSeq::value_type, ::sbepp::endian::little>(*this, 44);
    }
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_compatible_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR auto
        avgDailyTradedQty(Cursor&& c) const noexcept
            -> ::sbepp::detail::cursor_result_type_t<Cursor, ::bovespa_mbo_sbe::types::QuantityVolumeOptional>
    {
        return c.template get_value<::bovespa_mbo_sbe::types::QuantityVolumeOptional, ::std::int64_t, ::sbepp::endian::little>(
            *this, 3, 20);
    }
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_writeable_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR void avgDailyTradedQty(
        ::bovespa_mbo_sbe::types::QuantityVolumeOptional v, Cursor&& c) const noexcept
    {
        return c.template set_value<::sbepp::endian::little>(
            *this, 3, 20, v.value());
    }
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_compatible_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR auto
        maxTradeVol(Cursor&& c) const noexcept
            -> ::sbepp::detail::cursor_result_type_t<Cursor, ::bovespa_mbo_sbe::types::QuantityVolumeOptional>
    {
        return c.template get_value<::bovespa_mbo_sbe::types::QuantityVolumeOptional, ::std::int64_t, ::sbepp::endian::little>(
            *this, 0, 28);
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_writeable_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR void maxTradeVol(
        ::bovespa_mbo_sbe::types::QuantityVolumeOptional v, Cursor&& c) const noexcept
    {
        return c.template set_value<::sbepp::endian::little>(
            *this, 0, 28, v.value());
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::QuantityBand_21{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::QuantityBand_21::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::QuantityBand_21::matchEventIndicator{})
||v.template on_field(this->avgDailyTradedQty(c), ::bovespa_mbo_sbe::schema::messages::QuantityBand_21::avgDailyTradedQty{})
||v.template on_field(this->maxTradeVol(c), ::bovespa_mbo_sbe::schema::messages::QuantityBand_21::maxTradeVol{})
||v.template on_field(this->mDEntryTimestamp(c), ::bovespa_mbo_sbe::schema::messages::QuantityBand_21::mDEntryTimestamp{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::QuantityBand_21::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using QuantityBand_21 = ::bovespa_mbo_sbe::detail::messages::message_15<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::mDUpdateAction>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::mDEntryType>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Entry type: Quantity Band.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::avgDailyTradedQty>
{
public:
    static constexpr const char* name() noexcept
    {
        return "avgDailyTradedQty";
    }
    ...
    static constexpr const char* description() noexcept
    {
        return "Daily average shares traded within 30 days – equity market only. Previously known as DailyAvgShares30D. Always 0 for Derivatives.";
    }
    ...
    using value_type = ::bovespa_mbo_sbe::types::QuantityVolumeOptional;
    using value_type_tag = ::bovespa_mbo_sbe::schema::types::QuantityVolumeOptional;
};

template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::maxTradeVol>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "The maximum order quantity that can be submitted for a security. The value is the minimum between % of shares issued and % of average traded quantity within 30 days.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::mDEntryTimestamp>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::QuantityBand_21>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::QuantityBand_21<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::QuantityBand_21<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::QuantityBand_21;
};
