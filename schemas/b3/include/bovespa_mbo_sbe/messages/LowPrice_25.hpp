...
class message_18 : public ::sbepp::detail::message_base<
...
public:
    ...
    {
        return ::bovespa_mbo_sbe::types::MDEntryType{::bovespa_mbo_sbe::detail::types::enum_31::SESSION_LOW_PRICE};
    }
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::LowPrice_25{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::matchEventIndicator{})
||v.template on_field(this->mDUpdateAction(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDUpdateAction{})
||v.template on_field(this->tradeDate(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::tradeDate{})
||v.template on_field(this->mDEntryPx(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDEntryPx{})
||v.template on_field(this->mDEntryTimestamp(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDEntryTimestamp{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::LowPrice_25::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using LowPrice_25 = ::bovespa_mbo_sbe::detail::messages::message_18<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDUpdateAction>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDEntryType>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Entry type: Trading Session Low Price.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::tradeDate>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDEntryPx>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::mDEntryTimestamp>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::LowPrice_25>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "The lowest price traded for the security in the trading session.";
    }
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::LowPrice_25<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::LowPrice_25<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::LowPrice_25;
};
