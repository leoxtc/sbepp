...
class message_13 : public ::sbepp::detail::message_base<
...
public:
    ...
    {
        return ::bovespa_mbo_sbe::types::MDEntryType{::bovespa_mbo_sbe::detail::types::enum_31::IMBALANCE};
    }
    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::types::ImbalanceCondition imbalanceCondition() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::ImbalanceCondition, ::std::uint16_t, ::sbepp::endian::little>(*this, 18);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void imbalanceCondition(::bovespa_mbo_sbe::types::ImbalanceCondition v) const noexcept
    {
    ...
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::QuantityOptional, ::bovespa_mbo_sbe::types::QuantityOptional::value_type, ::sbepp::endian::little>(*this, 20);
    }
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_compatible_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR auto
        imbalanceCondition(Cursor&& c) const noexcept
        -> ::sbepp::detail::cursor_result_type_t<Cursor, ::bovespa_mbo_sbe::types::ImbalanceCondition>
    {
        return c.template get_value<::bovespa_mbo_sbe::types::ImbalanceCondition, ::std::uint16_t, ::sbepp::endian::little>(
            *this, 0, 18);
    }
    ...
    template<
        ...
        typename = ::sbepp::detail::enable_if_cursor_writeable_t<
            Byte, ::sbepp::detail::cursor_byte_type_t<Cursor>>>
    SBEPP_CPP20_CONSTEXPR void imbalanceCondition(
        ::bovespa_mbo_sbe::types::ImbalanceCondition v, Cursor&& c) const noexcept
    {
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::matchEventIndicator{})
||v.template on_field(this->mDUpdateAction(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDUpdateAction{})
||v.template on_field(this->imbalanceCondition(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::imbalanceCondition{})
||v.template on_field(this->mDEntrySize(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDEntrySize{})
||v.template on_field(this->mDEntryTimestamp(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDEntryTimestamp{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using AuctionImbalance_19 = ::bovespa_mbo_sbe::detail::messages::message_13<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDUpdateAction>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDEntryType>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::imbalanceCondition>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "IMBALANCE_MORE_BUYERS, IMBALANCE_MORE_SELLERS, All bits off => BALANCED.";
    }
    ...
    using value_type_tag = ::bovespa_mbo_sbe::schema::types::ImbalanceCondition;
};

template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDEntrySize>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Remaining auction quantity.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::mDEntryTimestamp>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Carries auction imbalance information, indicating the remaining quantity and to which side (buyer or seller) the auction is pending towards.";
    }
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::AuctionImbalance_19<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::AuctionImbalance_19<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::AuctionImbalance_19;
};
