...
class message_28 : public ::sbepp::detail::message_base<
...
public:
    ...
    {
        return ::bovespa_mbo_sbe::types::MDUpdateAction{::bovespa_mbo_sbe::detail::types::enum_16::DELETE};
    }
    static constexpr ::bovespa_mbo_sbe::types::MDEntryType mDEntryType() noexcept
    {
        return ::bovespa_mbo_sbe::types::MDEntryType{::bovespa_mbo_sbe::detail::types::enum_31::TRADE_BUST};
    }
    ...
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::types::LocalMktDate, ::bovespa_mbo_sbe::types::LocalMktDate::value_type, ::sbepp::endian::little>(*this, 40);
    }
    ...
    {
        v.template on_message(*this, c, ::bovespa_mbo_sbe::schema::messages::TradeBust_57{});
    }
    ...
    {
        return v.template on_field(this->securityID(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::securityID{})
||v.template on_field(this->matchEventIndicator(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::matchEventIndicator{})
||v.template on_field(this->tradingSessionID(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::tradingSessionID{})
||v.template on_field(this->mDEntryPx(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntryPx{})
||v.template on_field(this->mDEntrySize(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntrySize{})
||v.template on_field(this->tradeID(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::tradeID{})
||v.template on_field(this->tradeDate(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::tradeDate{})
||v.template on_field(this->mDEntryTimestamp(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntryTimestamp{})
||v.template on_field(this->rptSeq(c), ::bovespa_mbo_sbe::schema::messages::TradeBust_57::rptSeq{});
    }
...
namespace messages
{
    ...
    template<typename Byte>
    using TradeBust_57 = ::bovespa_mbo_sbe::detail::messages::message_28<Byte>;
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::messageType>
{
public:
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::applVerID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::securityID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::securityIDSource>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::securityExchange>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::matchEventIndicator>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDUpdateAction>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Update Action (DELETE) = always delete.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntryType>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::tradingSessionID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntryPx>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntrySize>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::tradeID>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::tradeDate>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::mDEntryTimestamp>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Date and Time of Trade Bust.";
    }
...
template<>
class field_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57::rptSeq>
{
public:
    static constexpr const char* name() noexcept
    {
...
template<>
class message_traits<::bovespa_mbo_sbe::schema::messages::TradeBust_57>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Relays trade bust (trade reversal) information on one instrument.";
    }
    ...
    template<typename Byte>
    using value_type = ::bovespa_mbo_sbe::messages::TradeBust_57<Byte>;
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::messages::TradeBust_57<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::messages::TradeBust_57;
};
