...
class type_66
    : public ::sbepp::detail::optional_base<::std::int64_t, type_66>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int64_t, type_66>::optional_base;
...
using type_67 = ::std::int8_t;


template<typename Byte>
class composite_9 : public ::sbepp::detail::composite_base<Byte>
{
public:
    using ::sbepp::detail::composite_base<Byte>::composite_base;
    using ::sbepp::detail::composite_base<Byte>::operator();

    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::detail::types::type_66 mantissa() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::detail::types::type_66, ::bovespa_mbo_sbe::detail::types::type_66::value_type, ::sbepp::endian::little>(*this, 0);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void mantissa(::bovespa_mbo_sbe::detail::types::type_66 v) const noexcept
    {
    ...
    {
        return v.template on_composite(*this, ::bovespa_mbo_sbe::schema::types::RatioQty{});
    }
    ...
    {
        return v.template on_type(this->mantissa(), ::bovespa_mbo_sbe::schema::types::RatioQty::mantissa{});
    }
...
namespace types
{
    ...
    template<typename Byte>
    using RatioQty = ::bovespa_mbo_sbe::detail::types::composite_9<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::RatioQty::mantissa>
{
public:
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_66;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::detail::types::type_66>
{
    using type = ::bovespa_mbo_sbe::schema::types::RatioQty::mantissa;
};


template<>
class type_traits<::bovespa_mbo_sbe::schema::types::RatioQty::exponent>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_67;
};



template<>
class composite_traits<::bovespa_mbo_sbe::schema::types::RatioQty>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Ratio of quantity relative to the whole thing.";
    }
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::types::RatioQty<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::types::RatioQty;
};
