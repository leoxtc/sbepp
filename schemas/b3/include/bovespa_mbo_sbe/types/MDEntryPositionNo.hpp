...
class type_13
    : public ::sbepp::detail::required_base<::std::uint32_t, type_13>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint32_t, type_13>::required_base;
...
namespace types
{
using MDEntryPositionNo = ::bovespa_mbo_sbe::detail::types::type_13;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::MDEntryPositionNo>
{
public:
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::MDEntryPositionNo>
{
    using type = ::bovespa_mbo_sbe::schema::types::MDEntryPositionNo;
};
