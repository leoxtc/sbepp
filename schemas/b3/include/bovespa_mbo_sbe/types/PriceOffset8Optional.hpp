...
class type_56
    : public ::sbepp::detail::optional_base<::std::int64_t, type_56>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int64_t, type_56>::optional_base;
...
using type_57 = ::std::int8_t;


template<typename Byte>
class composite_7 : public ::sbepp::detail::composite_base<Byte>
{
public:
    using ::sbepp::detail::composite_base<Byte>::composite_base;
    using ::sbepp::detail::composite_base<Byte>::operator();

    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::detail::types::type_56 mantissa() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::detail::types::type_56, ::bovespa_mbo_sbe::detail::types::type_56::value_type, ::sbepp::endian::little>(*this, 0);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void mantissa(::bovespa_mbo_sbe::detail::types::type_56 v) const noexcept
    {
    ...
    {
        return v.template on_composite(*this, ::bovespa_mbo_sbe::schema::types::PriceOffset8Optional{});
    }
    ...
    {
        return v.template on_type(this->mantissa(), ::bovespa_mbo_sbe::schema::types::PriceOffset8Optional::mantissa{});
    }
...
namespace types
{
    ...
    template<typename Byte>
    using PriceOffset8Optional = ::bovespa_mbo_sbe::detail::types::composite_7<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::PriceOffset8Optional::mantissa>
{
public:
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_56;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::detail::types::type_56>
{
    using type = ::bovespa_mbo_sbe::schema::types::PriceOffset8Optional::mantissa;
};


template<>
class type_traits<::bovespa_mbo_sbe::schema::types::PriceOffset8Optional::exponent>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_57;
};



template<>
class composite_traits<::bovespa_mbo_sbe::schema::types::PriceOffset8Optional>
{
public:
    static constexpr const char* name() noexcept
    {
        return "PriceOffset8Optional";
    }

    static constexpr const char* description() noexcept
    {
        return "Price Offset (8 decimal places). Offsets related to prices subjected to be adjusted from corporate events.";
    }
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::types::PriceOffset8Optional<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::types::PriceOffset8Optional;
};
