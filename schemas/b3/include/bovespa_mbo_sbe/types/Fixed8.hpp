...
class type_73
    : public ::sbepp::detail::optional_base<::std::int64_t, type_73>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int64_t, type_73>::optional_base;
...
using type_74 = ::std::int8_t;


template<typename Byte>
class composite_12 : public ::sbepp::detail::composite_base<Byte>
{
public:
    using ::sbepp::detail::composite_base<Byte>::composite_base;
    using ::sbepp::detail::composite_base<Byte>::operator();

    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::detail::types::type_73 mantissa() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::detail::types::type_73, ::bovespa_mbo_sbe::detail::types::type_73::value_type, ::sbepp::endian::little>(*this, 0);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void mantissa(::bovespa_mbo_sbe::detail::types::type_73 v) const noexcept
    {
    ...
    {
        return v.template on_composite(*this, ::bovespa_mbo_sbe::schema::types::Fixed8{});
    }
    ...
    {
        return v.template on_type(this->mantissa(), ::bovespa_mbo_sbe::schema::types::Fixed8::mantissa{});
    }
...
namespace types
{
    ...
    template<typename Byte>
    using Fixed8 = ::bovespa_mbo_sbe::detail::types::composite_12<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Fixed8::mantissa>
{
public:
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_73;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::detail::types::type_73>
{
    using type = ::bovespa_mbo_sbe::schema::types::Fixed8::mantissa;
};


template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Fixed8::exponent>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_74;
};



template<>
class composite_traits<::bovespa_mbo_sbe::schema::types::Fixed8>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Optional decimal with constant exponent -8.";
    }
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::types::Fixed8<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::types::Fixed8;
};
