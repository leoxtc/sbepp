...
using type_8 = ::sbepp::detail::static_array_ref<
    Byte, char, 20, ::bovespa_mbo_sbe::schema::types::Symbol>;
...
namespace types
{
    ...
    template<typename Byte>
    using Symbol = ::bovespa_mbo_sbe::detail::types::type_8<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Symbol>
{
public:
