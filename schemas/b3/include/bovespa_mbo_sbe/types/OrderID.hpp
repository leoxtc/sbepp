...
class type_10
    : public ::sbepp::detail::required_base<::std::uint64_t, type_10>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint64_t, type_10>::required_base;
...
namespace types
{
using OrderID = ::bovespa_mbo_sbe::detail::types::type_10;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::OrderID>
{
public:
    ...
    {
        return "Unique identifier for Order as assigned by the exchange.";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::OrderID>
{
    using type = ::bovespa_mbo_sbe::schema::types::OrderID;
};
