...
class type_62
    : public ::sbepp::detail::optional_base<::std::uint16_t, type_62>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::uint16_t, type_62>::optional_base;
...
namespace types
{
using LocalMktDateOptional = ::bovespa_mbo_sbe::detail::types::type_62;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::LocalMktDateOptional>
{
public:
    static constexpr const char* name() noexcept
    {
        return "LocalMktDateOptional";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::LocalMktDateOptional>
{
    using type = ::bovespa_mbo_sbe::schema::types::LocalMktDateOptional;
};
