...
class type_16
    : public ::sbepp::detail::optional_base<::std::int32_t, type_16>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int32_t, type_16>::optional_base;
...
namespace types
{
using Int32NULL = ::bovespa_mbo_sbe::detail::types::type_16;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Int32NULL>
{
public:
    ...
    {
        return "4-byte signed integer, from -2147483648 (-2^31) to 2147483647 (2^31-1), NULL (optional) value = 0.";
    }
    ...
    using value_type = ::bovespa_mbo_sbe::types::Int32NULL;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::types::Int32NULL>
{
    using type = ::bovespa_mbo_sbe::schema::types::Int32NULL;
};
