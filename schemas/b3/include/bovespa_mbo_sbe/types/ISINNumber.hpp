...
using type_4 = ::sbepp::detail::static_array_ref<
    Byte, char, 12, ::bovespa_mbo_sbe::schema::types::ISINNumber>;
...
namespace types
{
    ...
    template<typename Byte>
    using ISINNumber = ::bovespa_mbo_sbe::detail::types::type_4<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::ISINNumber>
{
public:
    ...
    {
        return "ISIN Number (SecurityAltID).";
    }
