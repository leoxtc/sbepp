...
using type_59 = ::sbepp::detail::static_array_ref<
    Byte, char, 2, ::bovespa_mbo_sbe::schema::types::LanguageCode>;
...
namespace types
{
    ...
    template<typename Byte>
    using LanguageCode = ::bovespa_mbo_sbe::detail::types::type_59<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::LanguageCode>
{
public:
