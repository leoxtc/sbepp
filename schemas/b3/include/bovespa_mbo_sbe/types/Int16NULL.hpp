...
class type_35
    : public ::sbepp::detail::optional_base<::std::int16_t, type_35>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int16_t, type_35>::optional_base;
...
namespace types
{
using Int16NULL = ::bovespa_mbo_sbe::detail::types::type_35;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Int16NULL>
{
public:
    ...
    {
        return "2-byte unsigned integer, from -32768 to 32767, NULL (optional) value = 0.";
    }
    ...
    using value_type = ::bovespa_mbo_sbe::types::Int16NULL;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::types::Int16NULL>
{
    using type = ::bovespa_mbo_sbe::schema::types::Int16NULL;
};
