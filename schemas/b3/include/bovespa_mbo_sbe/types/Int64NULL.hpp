...
class type_52
    : public ::sbepp::detail::optional_base<::std::int64_t, type_52>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int64_t, type_52>::optional_base;
...
namespace types
{
using Int64NULL = ::bovespa_mbo_sbe::detail::types::type_52;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Int64NULL>
{
public:
    ...
    {
        return "8-byte signed integer, from -9223372036854775808 (-2^63) to 9223372036854775807 (2^63-1), NULL (optional) value = 0.";
    }
    ...
    using value_type = ::bovespa_mbo_sbe::types::Int64NULL;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::types::Int64NULL>
{
    using type = ::bovespa_mbo_sbe::schema::types::Int64NULL;
};
