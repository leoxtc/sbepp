...
class type_86
    : public ::sbepp::detail::required_base<::std::uint16_t, type_86>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint16_t, type_86>::required_base;
...
namespace types
{
using SettlType = ::bovespa_mbo_sbe::detail::types::type_86;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::SettlType>
{
public:
    ...
    {
        return "Indicates order settlement period in days. (e.g. 0, D1, D2, D3, D60, D120 etc.) If present, SettlDate (64) overrides this field.";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::SettlType>
{
    using type = ::bovespa_mbo_sbe::schema::types::SettlType;
};
