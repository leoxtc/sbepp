...
class type_51
    : public ::sbepp::detail::optional_base<::std::int64_t, type_51>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int64_t, type_51>::optional_base;
...
namespace types
{
using QuantityVolumeOptional = ::bovespa_mbo_sbe::detail::types::type_51;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::QuantityVolumeOptional>
{
public:
    static constexpr const char* name() noexcept
    {
        return "QuantityVolumeOptional";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::QuantityVolumeOptional>
{
    using type = ::bovespa_mbo_sbe::schema::types::QuantityVolumeOptional;
};
