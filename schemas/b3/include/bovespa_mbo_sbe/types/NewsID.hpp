...
class type_45
    : public ::sbepp::detail::optional_base<::std::uint64_t, type_45>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::uint64_t, type_45>::optional_base;
...
namespace types
{
using NewsID = ::bovespa_mbo_sbe::detail::types::type_45;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::NewsID>
{
public:
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::NewsID>
{
    using type = ::bovespa_mbo_sbe::schema::types::NewsID;
};
