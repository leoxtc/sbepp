...
namespace types
{
using SecurityID = ::bovespa_mbo_sbe::detail::types::type_5;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::SecurityID>
{
public:
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::SecurityID>
{
    using type = ::bovespa_mbo_sbe::schema::types::SecurityID;
};
