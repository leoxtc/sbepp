...
using type_58 = ::sbepp::detail::static_array_ref<
    Byte, char, 2, ::bovespa_mbo_sbe::schema::types::CountryCode>;
...
namespace types
{
    ...
    template<typename Byte>
    using CountryCode = ::bovespa_mbo_sbe::detail::types::type_58<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::CountryCode>
{
public:
