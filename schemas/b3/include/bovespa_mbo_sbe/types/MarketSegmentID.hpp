...
class type_20
    : public ::sbepp::detail::optional_base<::std::uint8_t, type_20>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::uint8_t, type_20>::optional_base;
...
namespace types
{
using MarketSegmentID = ::bovespa_mbo_sbe::detail::types::type_20;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::MarketSegmentID>
{
public:
    ...
    {
        return "Identifies the market segment. Required for all tradable instruments. Not present in equity indexes, ETF indexes, BTB and Option Exercise.";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::MarketSegmentID>
{
    using type = ::bovespa_mbo_sbe::schema::types::MarketSegmentID;
};
