...
class type_49
    : public ::sbepp::detail::optional_base<::std::int8_t, type_49>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int8_t, type_49>::optional_base;
...
namespace types
{
using Int8NULL = ::bovespa_mbo_sbe::detail::types::type_49;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Int8NULL>
{
public:
    ...
    {
        return "1-byte signed integer, from -128 to 127, NULL (optional) value = 0.";
    }
    ...
    using value_type = ::bovespa_mbo_sbe::types::Int8NULL;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::types::Int8NULL>
{
    using type = ::bovespa_mbo_sbe::schema::types::Int8NULL;
};
