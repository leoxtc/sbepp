...
class type_29
    : public ::sbepp::detail::required_base<::std::uint32_t, type_29>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint32_t, type_29>::required_base;
...
namespace types
{
using UInt32 = ::bovespa_mbo_sbe::detail::types::type_29;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::UInt32>
{
public:
    ...
    {
        return "4-byte unsigned integer, from 0 to 4294967295 (2^32-1).";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::UInt32>
{
    using type = ::bovespa_mbo_sbe::schema::types::UInt32;
};
