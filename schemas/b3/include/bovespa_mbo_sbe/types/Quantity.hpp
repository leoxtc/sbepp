...
class type_15
    : public ::sbepp::detail::required_base<::std::int64_t, type_15>
{
public:
    using ::sbepp::detail::required_base<
        ::std::int64_t, type_15>::required_base;
...
namespace types
{
using Quantity = ::bovespa_mbo_sbe::detail::types::type_15;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Quantity>
{
public:
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::Quantity>
{
    using type = ::bovespa_mbo_sbe::schema::types::Quantity;
};
