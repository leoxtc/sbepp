...
class type_36
    : public ::sbepp::detail::required_base<::std::uint64_t, type_36>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint64_t, type_36>::required_base;
...
namespace types
{
using UInt64 = ::bovespa_mbo_sbe::detail::types::type_36;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::UInt64>
{
public:
    ...
    {
        return "8-byte unsigned integer, from 0 to 18446744073709551615 (2^64-1).";
    }
    ...
    using value_type = ::bovespa_mbo_sbe::types::UInt64;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::types::UInt64>
{
    using type = ::bovespa_mbo_sbe::schema::types::UInt64;
};
