...
class type_12
    : public ::sbepp::detail::required_base<::std::int64_t, type_12>
{
public:
    using ::sbepp::detail::required_base<
        ::std::int64_t, type_12>::required_base;
...
namespace types
{
using QuantityVolume = ::bovespa_mbo_sbe::detail::types::type_12;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::QuantityVolume>
{
public:
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::QuantityVolume>
{
    using type = ::bovespa_mbo_sbe::schema::types::QuantityVolume;
};
