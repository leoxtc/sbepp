...
class type_55
    : public ::sbepp::detail::optional_base<::std::uint64_t, type_55>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::uint64_t, type_55>::optional_base;
...
namespace types
{
using UInt64NULL = ::bovespa_mbo_sbe::detail::types::type_55;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::UInt64NULL>
{
public:
    ...
    {
        return "8-byte unsigned integer, from 1 to 18446744073709551615 (2^64-1), NULL (optional) value = 0.";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::UInt64NULL>
{
    using type = ::bovespa_mbo_sbe::schema::types::UInt64NULL;
};
