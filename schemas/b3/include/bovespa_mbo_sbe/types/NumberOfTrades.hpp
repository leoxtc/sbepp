...
class type_34
    : public ::sbepp::detail::required_base<::std::uint32_t, type_34>
{
public:
    using ::sbepp::detail::required_base<
        ::std::uint32_t, type_34>::required_base;
...
namespace types
{
using NumberOfTrades = ::bovespa_mbo_sbe::detail::types::type_34;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::NumberOfTrades>
{
public:
    ...
    {
        return "Contains the number of trades executed in the session.";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::NumberOfTrades>
{
    using type = ::bovespa_mbo_sbe::schema::types::NumberOfTrades;
};
