...
class type_64
    : public ::sbepp::detail::optional_base<::std::int64_t, type_64>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::int64_t, type_64>::optional_base;
...
using type_65 = ::std::int8_t;


template<typename Byte>
class composite_8 : public ::sbepp::detail::composite_base<Byte>
{
public:
    using ::sbepp::detail::composite_base<Byte>::composite_base;
    using ::sbepp::detail::composite_base<Byte>::operator();

    SBEPP_CPP20_CONSTEXPR ::bovespa_mbo_sbe::detail::types::type_64 mantissa() const noexcept
    {
        return ::sbepp::detail::get_value<
            ::bovespa_mbo_sbe::detail::types::type_64, ::bovespa_mbo_sbe::detail::types::type_64::value_type, ::sbepp::endian::little>(*this, 0);
    }

    template<
        typename T = void,
        typename = ::sbepp::detail::enable_if_writable_t<Byte, T>>
    SBEPP_CPP20_CONSTEXPR void mantissa(::bovespa_mbo_sbe::detail::types::type_64 v) const noexcept
    {
    ...
    {
        return v.template on_composite(*this, ::bovespa_mbo_sbe::schema::types::Percentage{});
    }
    ...
    {
        return v.template on_type(this->mantissa(), ::bovespa_mbo_sbe::schema::types::Percentage::mantissa{});
    }
...
namespace types
{
    ...
    template<typename Byte>
    using Percentage = ::bovespa_mbo_sbe::detail::types::composite_8<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Percentage::mantissa>
{
public:
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_64;
};

template<>
struct traits_tag<::bovespa_mbo_sbe::detail::types::type_64>
{
    using type = ::bovespa_mbo_sbe::schema::types::Percentage::mantissa;
};


template<>
class type_traits<::bovespa_mbo_sbe::schema::types::Percentage::exponent>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    using value_type = ::bovespa_mbo_sbe::detail::types::type_65;
};



template<>
class composite_traits<::bovespa_mbo_sbe::schema::types::Percentage>
{
public:
    static constexpr const char* name() noexcept
    {
    ...
    static constexpr const char* description() noexcept
    {
        return "Optional percentage (4 decimal places).";
    }
...
template<typename Byte>
struct traits_tag<::bovespa_mbo_sbe::types::Percentage<Byte>>
{
    using type = ::bovespa_mbo_sbe::schema::types::Percentage;
};
