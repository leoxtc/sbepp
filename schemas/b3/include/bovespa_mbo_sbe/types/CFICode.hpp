...
using type_30 = ::sbepp::detail::static_array_ref<
    Byte, char, 6, ::bovespa_mbo_sbe::schema::types::CFICode>;
...
namespace types
{
    ...
    template<typename Byte>
    using CFICode = ::bovespa_mbo_sbe::detail::types::type_30<Byte>;
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::CFICode>
{
public:
