...
class type_85
    : public ::sbepp::detail::optional_base<::std::uint16_t, type_85>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::uint16_t, type_85>::optional_base;
...
namespace types
{
using UInt16NULL = ::bovespa_mbo_sbe::detail::types::type_85;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::UInt16NULL>
{
public:
    ...
    {
        return "2-byte unsigned integer, from 1 to 65535, NULL (optional) value = 0.";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::UInt16NULL>
{
    using type = ::bovespa_mbo_sbe::schema::types::UInt16NULL;
};
