...
class type_3
    : public ::sbepp::detail::optional_base<::std::uint64_t, type_3>
{
public:
    using ::sbepp::detail::optional_base<
        ::std::uint64_t, type_3>::optional_base;
...
namespace types
{
using ClearingHouseID = ::bovespa_mbo_sbe::detail::types::type_3;
} // namespace types
} // namespace bovespa_mbo_sbe
...
template<>
class type_traits<::bovespa_mbo_sbe::schema::types::ClearingHouseID>
{
public:
    ...
    {
        return "ClearingHouseID (SecurityAltID).";
    }
...
template<>
struct traits_tag<::bovespa_mbo_sbe::types::ClearingHouseID>
{
    using type = ::bovespa_mbo_sbe::schema::types::ClearingHouseID;
};
